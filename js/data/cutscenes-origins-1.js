...
//  Arc: fog -> rain -> fog -> embers -> sparks
// =============================================================================

window.Latency.CutsceneData['origin_human'] = {
    id: 'origin_human',
    title: 'BORN IN THE MARGINS',
    music: 1,  // Void Glider — ambient drift, fitting for anonymity
    slides: [
        {
        ...
        },
        {
            ...
            mood: 'melancholy',
            music: 25,  // Yearning — emotional weight of worthlessness
            duration: 0
        },
        {
        ...
        },
        {
            ...
            mood: 'neutral',
            music: 13,  // Observe — mystery, quiet awareness
            duration: 0
        },
        {
        ...
        },
        {
            ...
            mood: 'tension',
            music: 17,  // Nightchaser — rising tension, determination building
            duration: 0
        },
        {
        ...
        },
        {
            ...
            mood: 'determination',
            music: 21,  // Rise of Heroes — defiant resolve
            duration: 0
        }
    ],
    onComplete: 'gameplay'
...
//  Arc: embers -> fog -> embers -> embers -> rain -> fog -> embers -> embers -> embers -> embers -> sparks
// =============================================================================

window.Latency.CutsceneData['origin_orc'] = {
    id: 'origin_orc',
    title: 'SLAG AND BLOOD',
    music: 3,  // Neon Noir — heavy industrial atmosphere
    slides: [
        {
        ...
        },
        {
            ...
            mood: 'dark',
            music: 24,  // Endings — grief, loss of father
            duration: 0
        },
        {
        ...
        },
        {
            ...
            mood: 'dark',
            music: 25,  // Yearning — devastating helplessness
            duration: 0
        },
        {
            ...
            mood: 'red',
            music: 8,  // Fall of Heroes — death and rage igniting
            duration: 0
        },
        {
        ...
        },
        {
            ...
            mood: 'red',
            music: 9,  // Conquer — explosive violence, catharsis
            duration: 0
        },
        {
            ...
            mood: 'determination',
            music: 21,  // Rise of Heroes — defiant march forward
            duration: 0
        }
    ],
    onComplete: 'gameplay'
...
//  Arc: stars -> stars -> stars -> embers -> embers -> fog -> embers -> fog -> rain -> rain -> sparks
// =============================================================================

window.Latency.CutsceneData['origin_wood_elf'] = {
    id: 'origin_wood_elf',
    title: 'THE LAST GROVE',
    music: 0,  // Underglow — gentle ambient, nature's peace
    slides: [
        {
        ...
        },
        {
            ...
            mood: 'tension',
            music: 14,  // Corrupted — dread, first threat
            duration: 0
        },
        {
        ...
        },
        {
            ...
            mood: 'red',
            music: 8,  // Fall of Heroes — destruction begins
            duration: 0
        },
        {
        ...
        },
        {
            ...
            mood: 'red',
            music: 24,  // Endings — irreversible loss
            duration: 0
        },
        {
            ...
            mood: 'cold',
            music: 25,  // Yearning — collective mourning
            duration: 0
        },
        {
        ...
        },
        {
            ...
            mood: 'determination',
            music: 29,  // Ascension — fierce hope from ashes
            duration: 0
        }
    ],
    onComplete: 'gameplay'
...
//  Arc: fog -> fog -> stars -> embers -> stars -> embers -> fog -> embers -> rain -> fog -> sparks
// =============================================================================

window.Latency.CutsceneData['origin_dark_elf'] = {
    id: 'origin_dark_elf',
    title: 'WHAT THE TUNNELS TEACH',
    music: 12,  // The Other Place — mystery, underground world
    slides: [
        {
        ...
        },
        {
            ...
            mood: 'dark',
            music: 17,  // Nightchaser — dangerous training
            duration: 0
        },
        {
        ...
        },
        {
            ...
            mood: 'dark',
            music: 3,  // Neon Noir — settled into underworld rhythm
            duration: 0
        },
        {
            ...
            mood: 'tension',
            music: 15,  // Dire Space Emergency — dread
            duration: 0
        },
        {
            ...
            mood: 'cold',
            music: 24,  // Endings — death of mentor
            duration: 0
        },
        {
        ...
        },
        {
            ...
            mood: 'melancholy',
            music: 28,  // Faded Dream — bittersweet revelation
            duration: 0
        },
        {
        ...
        },
        {
            ...
            mood: 'determination',
            music: 17,  // Nightchaser — the hunt begins
            duration: 0
        }
    ],
    onComplete: 'gameplay'
...
//  Arc: neon -> stars -> rain -> stars -> rain -> fog -> rain -> embers -> stars -> rain -> sparks
// =============================================================================

window.Latency.CutsceneData['origin_dwarf'] = {
    id: 'origin_dwarf',
    title: 'THE BONES OF THE CITY',
    music: 5,  // Amunet Prime — warm ambient, craft and legacy
    slides: [
        {
        ...
        },
        {
            ...
            mood: 'melancholy',
            music: 25,  // Yearning — stolen credit, quiet injustice
            duration: 0
        },
        {
            ...
            mood: 'neutral',
            music: 5,  // Amunet Prime — return to craft warmth
            duration: 0
        },
        {
        ...
        },
        {
            ...
            mood: 'cold',
            music: 24,  // Endings — death of grandmother
            duration: 0
        },
        {
            ...
            mood: 'melancholy',
            music: 28,  // Faded Dream — bittersweet legacy
            duration: 0
        },
        {
            ...
            mood: 'tension',
            music: 22,  // Gatekeepers — building resolve
            duration: 0
        },
        {
            ...
            mood: 'dark',
            music: 6,  // Action & Adventure — heroic repair
            duration: 0
        },
        {
            ...
            mood: 'blue',
            music: 25,  // Yearning — stolen legacy
            duration: 0
        },
        {
            ...
            mood: 'determination',
            music: 29,  // Ascension — defiant pride
            duration: 0
        }
    ],
    onComplete: 'gameplay'
