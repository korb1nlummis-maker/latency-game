 ...
 *
 * Mood->Effect mapping (via CinematicRenderer):
 *   dark/peaceful/neutral -> fog | red/tension/anger -> embers
 *   blue/melancholy/cold -> rain | eerie -> void
 *   warm -> neon | determination -> sparks
 *
 * Per-slide music cues use track indices 0-29.
 */
(function() {
    'use strict';
    ...
    // Arc: rain -> fog -> fog -> rain -> rain -> embers -> embers -> fog -> fog -> rain
    // =========================================================================
    window.Latency.CutsceneData['origin_half_giant'] = {
        id: 'origin_half_giant',
        title: 'Born to Break',
        race: 'half_giant',
        music: 26,  // Sailing Away — emotional, heavy with tenderness beneath
        slides: [
            {
            ...
            },
            {
                ...
                mood: 'blue',
                music: 28,  // Faded Dream — fragile tenderness
                duration: 0
            },
            {
            ...
            },
            {
                ...
                mood: 'red',
                music: 8,  // Fall of Heroes — catastrophic moment
                duration: 0
            },
            {
                ...
                mood: 'red',
                music: 24,  // Endings — devastating grief
                duration: 0
            },
            {
            ...
            },
            {
                ...
                mood: 'dark',
                music: 3,  // Neon Noir — numb, mechanical existence
                duration: 0
            },
            {
                ...
                mood: 'blue',
                music: 29,  // Ascension — fragile hope
                duration: 0
            }
        ],
        onComplete: 'gameplay'
    ...
    // Arc: rain -> fog -> fog -> fog -> rain -> fog -> rain -> rain -> embers -> embers
    // =========================================================================
    window.Latency.CutsceneData['origin_cyborg'] = {
        id: 'origin_cyborg',
        title: 'Replacement Parts',
        race: 'cyborg',
        music: 27,  // Suspended Animation — clinical, sterile, growing unease
        slides: [
            {
            ...
            },
            {
                ...
                mood: 'dark',
                music: 14,  // Corrupted — loss of self, piece by piece
                duration: 0
            },
            {
            ...
            },
            {
                ...
                mood: 'melancholy',
                music: 28,  // Faded Dream — memory of the old self
                duration: 0
            },
            {
            ...
            },
            {
                ...
                mood: 'blue',
                music: 25,  // Yearning — isolation, longing to feel
                duration: 0
            },
            {
            ...
            },
            {
                ...
                mood: 'tension',
                music: 15,  // Dire Space Emergency — threshold, edge of self
                duration: 0
            },
            {
                art: 'assets/images/scenes/memory-clinic.jpg',
                ...
                mood: 'determination',
                music: 21,  // Rise of Heroes — defiance, refusing to surrender identity
                duration: 0
            }
        ],
        onComplete: 'gameplay'
    ...
    // Arc: void -> rain -> fog -> fog -> rain -> rain -> fog -> rain -> embers -> embers
    // =========================================================================
    window.Latency.CutsceneData['origin_synth'] = {
        id: 'origin_synth',
        title: 'Boot Sequence',
        race: 'synth',
        music: 16,  // Diaphanous — ethereal, questioning, minimal electronic
        slides: [
            {
            ...
            },
            {
                ...
                mood: 'dark',
                music: 12,  // The Other Place — alienation, warehouse of copies
                duration: 0
            },
            {
            ...
            },
            {
                ...
                mood: 'blue',
                music: 28,  // Faded Dream — first spark of feeling
                duration: 0
            },
            {
                art: 'assets/images/scenes/city-skyline-night.jpg',
                ...
                mood: 'blue',
                music: 29,  // Ascension — beauty, wonder awakening
                duration: 0
            },
            {
                ...
                mood: 'dark',
                music: 16,  // Diaphanous — return to isolation
                duration: 0
            },
            {
                ...
                mood: 'cold',
                music: 25,  // Yearning — sadness discovered
                duration: 0
            },
            {
                ...
                mood: 'tension',
                music: 15,  // Dire Space Emergency — hunted
                duration: 0
            },
            {
                ...
                mood: 'determination',
                music: 21,  // Rise of Heroes — fierce awakening
                duration: 0
            }
        ],
        onComplete: 'gameplay'
    ...
    // Arc: fog -> rain -> fog -> fog -> rain -> rain -> fog -> fog -> embers -> embers
    // =========================================================================
    window.Latency.CutsceneData['origin_shadowkin'] = {
        id: 'origin_shadowkin',
        title: 'What the Rift Left Behind',
        race: 'shadowkin',
        music: 4,  // Dark Side of Mars — dark, eerie ambient, deep bass
        slides: [
            {
            ...
            },
            {
                ...
                mood: 'blue',
                music: 25,  // Yearning — mother's pain, desperate normalcy
                duration: 0
            },
            {
                ...
                mood: 'eerie',
                music: 14,  // Corrupted — whispers from the void
                duration: 0
            },
            {
            ...
            },
            {
                ...
                mood: 'melancholy',
                music: 28,  // Faded Dream — heartbreak of rejection
                duration: 0
            },
            {
            ...
            },
            {
                ...
                mood: 'dark',
                music: 12,  // The Other Place — answering the darkness
                duration: 0
            },
            {
                ...
                mood: 'eerie',
                music: 15,  // Dire Space Emergency — revelation
                duration: 0
            },
            {
            ...
            },
            {
                ...
                mood: 'determination',
                music: 19,  // Paladin's Underworld — dark power embraced
                duration: 0
            }
        ],
        onComplete: 'gameplay'
    ...
    // Arc: void -> fog -> fog -> rain -> rain -> embers -> fog -> rain -> fog -> embers
    // =========================================================================
    window.Latency.CutsceneData['origin_voidborn'] = {
        id: 'origin_voidborn',
        title: 'Signal and Noise',
        race: 'voidborn',
        music: 1,  // Void Glider — cosmic, alien, space ambient
        slides: [
            {
            ...
            },
            {
                ...
                mood: 'dark',
                music: 13,  // Observe — clinical, watching
                duration: 0
            },
            {
            ...
            },
            {
                ...
                mood: 'eerie',
                music: 16,  // Diaphanous — overwhelming perception
                duration: 0
            },
            {
                ...
                mood: 'blue',
                music: 27,  // Suspended Animation — suppressed, muted
                duration: 0
            },
            {
                ...
                mood: 'red',
                music: 24,  // Endings — helpless foresight, death
                duration: 0
            },
            {
                ...
                mood: 'dark',
                music: 4,  // Dark Side of Mars — psychic pressure
                duration: 0
            },
            {
            ...
            },
            {
                ...
                mood: 'eerie',
                music: 1,  // Void Glider — cosmic signal, alien connection
                duration: 0
            },
            {
                ...
                mood: 'determination',
                music: 29,  // Ascension — cosmic purpose
                duration: 0
            }
        ],
        onComplete: 'gameplay'
